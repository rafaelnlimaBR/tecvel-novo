                ...
                <form method="get" action="{{route('veiculo.index')}}">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control form-control-sm" value="{{request()->has('placa')?request()->get('placa'):''}}" name="placa" value=""  placeholder="Placa">
                      </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($veiculos as $veiculo)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('veiculo.editar',['veiculo'=>$veiculo])}}" class="btn btn-sm btn-warning" style="padding-top: 0; padding-bottom: 0"><i class="fa  fa-pencil-square"></i></a>
                                        <a href="{{route('veiculo.excluir',['veiculo'=>$veiculo])}}" onclick="return confirm('Deseja excluir esse registro?')" class="btn btn-sm btn-danger" style="padding-top: 0; padding-bottom: 0"><i class="fa  fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            @endforeach
